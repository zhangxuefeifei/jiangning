...
function APPAuthenticate() {
    ...
    if (userLoginInformation != undefined && userLoginInformation.loginData != undefined) {
        ...
        var postUrl = 'TokenAuth/APPAuthenticate';
        fnPost(postUrl, {
...
function checkZipDownloadSuccess(data, callback) {
    ...
    switch (true) {
        ...
        case data.coding == 'WaterStarOne-MRH-S8': //抄表管家
            ...
            break;
        case data.coding == "WaterStarOne-RM-S9": //决策系统
            appWgtZipUrlName = "decision"
            break;
        case data.coding == "WaterStarOne-GIS-S9": //GIS
            appWgtZipUrlName = "GIS"
            break;
        case data.coding == "WaterStarOne-Inspection-S9": //巡检系统
            appWgtZipUrlName = "inspection"
            break;
        case data.coding == "WaterStarOne-CRM-S8": //客户系统
            appWgtZipUrlName = "Customer"
            break;
        case data.coding == "WaterStarOne-CRM-S8": //报装系统
            appWgtZipUrlName = "baozhuang"
            break;
    ...
    fs.exist({
        path: ''+api.fsDir+ data.productName + '.zip'
    }, function(ret, err) {
        api.hideProgress();
        if (ret.exist) {
